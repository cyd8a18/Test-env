...
from env_utils import World, pb_session, URDFS
from third_party.pybullet.utils.models.ur5.utilities import setup_sisbot

from third_party.pybullet.utils.pybullet_tools.utils import get_model_path, set_pose, step_simulation, \
    Point, set_camera, get_lower_upper, draw_pose 
...
def teaching_env(args):
    ...
    ingredients = ingredients = ['cabbage', 'pumpkin', 'tomato', 'pear', 'orange', 'banana', 'mug']
